        ...
        <div id="carouselExample" class="carousel slide">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="images/home_bg_1.jpg" class="d-block w-100" alt="...">
                    <div class="text">
                        <h2 class="text-center" style="color: #ffe600;">we are Mahadev Devloper's</h2>
                        <h1 class="text-center">We can create your dream Real</h1>
                        <span class="text-center">Building dreams, exceeding expectations, and delivering excellence in real estate</span>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="images/home_bg_2.jpg" class="d-block w-100" alt="...">
                    <div class="text">
                        <h2 class="text-center" style="color: #ffe600;">we are Mahadev Devloper's</h2>
                        <h1 class="text-center">We can create your dream Real</h1>
                        <span class="text-center">Building dreams, exceeding expectations, and delivering excellence in real estate</span>
                ...
                <div class="carousel-item">
                    <img src="images/home_bg_4.jpg" class="d-block w-100" alt="...">
                    <div class="text">
                        <h2 class="text-center" style="color: #ffe600;">we are Mahadev Devloper's</h2>
                        <h1 class="text-center">We can create your dream Real</h1>
                        <span class="text-center">Building dreams, exceeding expectations, and delivering excellence in real estate</span>
            ...
            <div class="row d-flex align-items-center justify-content-center">
                <div class="about_area col-md-8 d-flex align-items-center justify-content-center flex-column">
                    ...
                    <div class="text">
                        ...
                        <p class="text-justify">Mahadev Developers is a leading provider of exceptional planning and construction services in
                            ...
                            Authority) certification.Our RERA registration number is <span style="">PCGRERA070723001648</span>. With over
    ...
    <section class="services">
        <div class="container-fluid">
            ...
            <div class="row d-flex align-items-center justify-content-center gap-5 px-2">
                <div class="col-md-3 services_box">
                    <div class="logo">
