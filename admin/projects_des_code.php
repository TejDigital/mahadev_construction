...
//     if($sql_run){
//         $_SESSION['fire_msg'] ="Thankyou";
//         header('location:../blog_view.php');
//     }
//     else{
//         $_SESSION['fire_msg'] ="Somthing went roung";
//         header('location:../blog_view.php');
//     }
...
if (isset($_POST['add_des'])) {
    ...
    if (!in_array($file_ext, $img_ext)) {
        ...
        $_SESSION['fire_msg'] = "img only in jpg ,png or jpeg ext";
        header('location:blog_des.php');
    } else {
...
if (isset($_POST['delete_des'])) {
    ...
    if ($query_delete_run) {
        ...
        $_SESSION['fire_msg'] = "Blog deleted";
        header('location:blog_des.php');
    } else {
        $_SESSION['fire_msg'] = "Des... deletion failed";
        header('location:blog_des.php');
    }
}
...
if (isset($_POST['upd_blog'])) {
    ...
    if ($new_img != '') {
        ...
        if ($connect_db) {
            ...
            $_SESSION['fire_msg'] = "Blog Updated";
            header('location:blog_des.php');
        } else {
