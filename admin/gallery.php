                    ...
                    <div class="card">
                        ...
                        <div class="card-body ">
                            <table id="example1" class="  table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php
                                    $query = "SELECT * FROM gallery_tbl ORDER BY created_at desc";
                                    ...
                                    ?>
                                            ...
                                            <td>
                                                <a href=image_edit.php?img_id=<?php echo $filds['gall_id']; ?> class='btn btn-info btn-sm '>Edit</a>
                                                <button type='button' value=<?php echo $filds['gall_id']; ?> class='btn btn-danger delete_img_btn btn-sm my-1'>Delete</button>
                                                <!-- <a href=cus_details.php?cus_id=<?php echo $filds['gall_id']; ?> class='btn btn-info btn-sm'> View</a> -->
                                            </td>
                                            </tr>
                                    <?php
                                        }
