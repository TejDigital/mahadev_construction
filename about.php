            ...
            <div class="row d-flex justify-content-center">
                <div class="col-md-12">
                    <div class="banner-con text-center">
                        <h1>About Us</h1>
                        <p> <a href="index.php" class="me-2">Home</a><i class="fa-solid fa-forward"></i><span> About Us</span></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid p-0">
        <div class="row m-0 p-0">
            <div class="col-md-6 p-0">
                <div class="img">
                    <img src="images/home_bg_4.jpg" class="" alt="">
                </div>
            </div>
            <div class="col-md-6 py-5">
                ...
                <div class="text">
                    <h4>We Build Everything</h4>
                    <h4 class="mb-3"> if you can dream</h4>
                    <p class="text-justify mb-3"> Mahadev Developers is a leading provider of exceptional planning and construction services in
